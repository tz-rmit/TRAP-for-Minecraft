...
void ins(uint16_t instr)
{
    ...
    if (0x8000 & opbit)  // TRAP
    {
        ...
        else
        {
            ...
            {
                int16_t startX = reg[R_R0];
                int16_t startY = reg[R_R1];
                int16_t startZ = reg[R_R2];
                int16_t endX = reg[R_R3];
                int16_t endY = reg[R_R4];                
                int16_t endZ = reg[R_R5];
